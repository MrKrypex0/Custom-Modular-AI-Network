...
# Load the .txt file into a list (assuming it contains one text line per row)
...
text_train = text_data[:train_size]
text_val = text_data[train_size:]

print("Training set size:", len(text_train))
print("Validation set size:", len(text_val))

# Create the training and validation files
with open('training.txt', 'w') as f_train:
...
def get_random_chunk(split):
    filename = "training.txt" if split == 'train' else "validation.txt"
